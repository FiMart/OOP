...
public class RiskAssesmentController implements Initializable
{
    ...
    public void displayUsername(String firstName, String lastName, String phoneNumber, String email, String userName, String password, String date, String address, String vaccine1, String vaccine2, String vaccine3, String vaccine4) {User user = new User(firstName, lastName, phoneNumber, email, userName, password, date, address, vaccine1, vaccine2, vaccine3, vaccine4);
    ...
    public void toHome(ActionEvent event) throws IOException
    {
        ...
        User user = new User(tempfirstname, templastname, tempphonenumLabel, tempemailLabel, tempusernameLabel, temppassword, tempbirthdayLabel, tempaddressLabel ,tempfirstvacLabel, tempsecondvacLabel, tempthirdvacLabel, tempfourthvacLabel);
